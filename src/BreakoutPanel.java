...
public class BreakoutPanel extends JPanel {
    ...
    /**
     * Components receive a call to paintComponent when Java is good and ready.
     * This JPanel is responsible for drawing all game elements -- bricks, paddle,
     * ball, background, text messages, etc. when it is called.  Similar to the
